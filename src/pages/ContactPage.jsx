      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="w-full lg:w-1/3">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mt-2 mb-6 text-gray-900 dark:text-white transition-colors">{t('startProject')}</h1>
            <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed transition-colors text-lg">
               {t('contactDesc')}
            </p>
          ...
          {/* Form */}
          <div className="w-full lg:w-2/3 bg-gray-50 dark:bg-[#112240] p-8 md:p-12 rounded-3xl shadow-2xl border border-gray-100 dark:border-gray-800 transition-colors duration-300">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button 
                type="submit" 
                className="w-full py-4 bg-gradient-to-r from-secondary to-accent text-dark font-bold rounded-xl hover:shadow-[0_0_20px_rgba(100,255,218,0.4)] transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2 text-lg"
              >
