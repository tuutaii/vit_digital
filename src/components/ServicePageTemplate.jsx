    ...
    <div className="bg-white dark:bg-[#020c1b] min-h-screen text-gray-800 dark:text-gray-200 overflow-hidden font-sans">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] bg-secondary/10 rounded-full blur-[100px] opacity-30 animate-pulse" />
          <div className="absolute bottom-[-10%] left-[-10%] w-[600px] h-[600px] bg-accent/10 rounded-full blur-[120px] opacity-30" />
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
             ...
             >
                <span className="inline-block py-1 px-3 rounded-full bg-secondary/10 text-secondary border border-secondary/20 text-sm font-semibold tracking-wide uppercase mb-6">
                  {serviceName}
                </span>
             </motion.div>
            
            <motion.h1 
              className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 dark:from-white dark:via-gray-200 dark:to-gray-400"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <Link 
                to="/lien-he"
                className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-secondary to-accent text-dark font-bold rounded-lg hover:shadow-[0_0_20px_rgba(100,255,218,0.4)] transition-all transform hover:-translate-y-1 text-center"
              >
              ...
              <HashLink
                 smooth
                 to="#process"
                 className="w-full sm:w-auto px-8 py-4 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white font-medium rounded-lg hover:bg-gray-50 dark:hover:bg-white/10 transition-all text-center"
              >
                {t('heroBtnProcess')}
              </HashLink>
            </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            {painPoints.map((point, index) => (
              <motion.div 
                key={index} 
                className="bg-white dark:bg-[#112240] p-6 rounded-xl border border-red-100 dark:border-red-900/30 shadow-lg hover:shadow-xl transition-all duration-300 group"
        ...
        <div className="container mx-auto px-4">
          ...
          >
            {solutions.map((sol, index) => (
              <motion.div 
                key={index} 
                className="bg-white dark:bg-[#112240] p-8 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 hover:border-secondary/50 dark:hover:border-secondary/50 transition-all duration-300 relative overflow-hidden group"
                variants={itemVariants}
              >
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-6">
              {processSteps.map((step, index) => (
                ...
                >
                  <div className="bg-gray-800 border border-gray-700 p-6 rounded-lg hover:bg-gray-750 transition-colors h-full flex flex-col items-center text-center">
      ...
      <section className="py-20 bg-white dark:bg-[#020c1b]">
        <div className="container mx-auto px-4">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-gray-50 dark:bg-[#112240] p-8 rounded-2xl border border-gray-100 dark:border-gray-800">
      ...
      <div className="fixed bottom-0 left-0 w-full p-4 bg-white dark:bg-[#112240] border-t border-gray-200 dark:border-gray-700 md:hidden z-50 flex justify-between items-center shadow-[0_-5px_20px_rgba(0,0,0,0.1)]">
         ...
         <Link to="/lien-he" className="px-6 py-3 bg-gradient-to-r from-secondary to-accent text-dark font-bold rounded-lg shadow-lg">
            {t('getStarted')}
         </Link>
      </div>
